...
<section class="d-flex justify-content-center align-items-center">
    <div class="frame-height rounded shadow animate__animated animate__fadeIn ">
        <h1 class="text-center third-color-border mt-5 mb-3">TOP PLAYERS <span class="span1">{{$round->liveMatch->name}}</span></h1>
                                ...
                                <div class="animate__animated animate__fadeIn animate__delay-2s">
                                    <div class="card-head primary-bg">
                                        <div class="row cont1 primary-bg animate__animated animate__fadeInLeft animate__delay-1s">
                                            ...
                                            <!-- <img src="https://media.discordapp.net/attachments/951867439325528124/951867801533038612/nima.png" class="player-img"> -->
                                    ...
                                    <div class="card-footer player-info row pt-3 primary-bg">
                                        <div class="col-4">
                                            <h2 class=" d-flext align-items-center text-center secondary-font-color">{{ $top_player->kill }}
                                            </h2>
                                        </div>
                                        <div class="col-4">
                                            <h2 class=" d-flext align-items-center ml-2 text-center secondary-font-color">{{ $top_player->totalKill }}</h2>
                                        </div>
                    ...
                    <div class="col-md-5 col-lg-5 colrank23 py-1 secondary-color">
                        <div class="row">
                            <div class="col-5 text-bold d-flex">
                                ...
                                <h2 class=" secondary-font-color display-5 ml-2">{{ $player->kill }}</h2>
                            </div>
                            <div class="col-7 d-flex">
                                <h3 class="player-actions primary-font-color pt-2">TOTAL KILL</h3>
                        ...
                        <div class="row d-flex">
                            ...
                            <div class="col-6">
                                <h2 class="secondary-font-color display-5 ml-2">{{ $player->contribution }}%</h2>
                            </div>
                        </div>
                    </div>
                </div>

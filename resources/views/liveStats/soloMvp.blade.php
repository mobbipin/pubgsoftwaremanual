    ...
    <section class="d-flex justify-content-center align-items-center">
        <div class="frame-height padding-top">
            <div class="d-flex justify-content-center mb-2">
                <h1 class="display-1 text-center font-weight-bold third-color-border">MOST VALUABLE PLAYER</h1>
                <h2 class="mt-5 ml-3 third-color-border">{{ $round->liveMatch->name }}</h2>
            </div>
                    ...
                    <table class="table table-lg table-borderless align-middle mb-0 bg-transparent">
                        ...
                        <tbody class="player-img animate__animated animate__fadeIn animate__delay-3s">
                            <tr>
                                ...
                                <td>
                                    <h1 class=" displaay-4 fw-normal secondary-font-color mb-1">{{ $top_player->kill }}</h1>
                                </td>
                            </tr>
                            <tr>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center">
                                        <div class="mt-3 ml-5">
                                            <h1 class="display-4 fw-bold mb-1 primary-font-color">OVERALL KILLS </h1>
                                        </div>
                                    </div>
                                </td>
                                <td>

...
/*!******************************************************************!*\
  !*** ./resources/assets/cms/assets/js/pages/rangeslider.init.js ***!
  \******************************************************************/
...
var resultElement = document.getElementById("result"),
    ...
    colors = [0, 0, 0];
[].slice.call(sliders).forEach(function (t, n) {
  noUiSlider.create(t, {
    start: 127,
    connect: [!0, !1],
...
for (var select = document.getElementById("input-select"), i = -20; i <= 40; i++) {
...
html5Slider.noUiSlider.on("update", function (e, t) {
  e = e[t];
...
nonLinearSlider.noUiSlider.on("update", function (e, t, n, l, i) {
...
function crossUpdate(e, t) {
  var n;
  lockedState && (e -= lockedValues[(n = slider1 === t ? 0 : 1) ? 0 : 1] - lockedValues[n], t.noUiSlider.set(e));
}
...
}), slider1.noUiSlider.on("change", setLockedValues), slider2.noUiSlider.on("change", setLockedValues), slider1.noUiSlider.on("slide", function (e, t) {
...
slider = document.getElementById("slider-color");
noUiSlider.create(slider, {
...
for (var connect = slider.querySelectorAll(".noUi-connect"), classes = ["c-1-color", "c-2-color", "c-3-color", "c-4-color", "c-5-color"], i = 0; i < connect.length; i++) {
